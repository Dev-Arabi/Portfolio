...
export default function TestimonialsPage() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "Exceptional network engineering expertise. Our company's connectivity has never been more reliable. The implementation was flawless and the support has been outstanding.",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "Outstanding server management skills. Resolved our performance issues and improved security significantly. Highly professional and knowledgeable.",
      rating: 5,
      project: "Server Optimization & Security",
      image: "/placeholder.svg?height=80&width=80",
    },
    {
      ...
      content:
        "Excellent full-stack development work. The web application exceeded our expectations in both functionality and design. Great communication throughout the project.",
      rating: 5,
                ...
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-slate-300">Professor, University</p>
